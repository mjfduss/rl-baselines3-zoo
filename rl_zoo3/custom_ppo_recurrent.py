...
# Custom policy
from rl_zoo3.custom_recurrent_policy import MlpCfcPolicy
...
class RecurrentPPO(OnPolicyAlgorithm):
    ...
    def _setup_model(self) -> None:
        ...
        buffer_cls = RecurrentDictRolloutBuffer if isinstance(
            self.observation_space, spaces.Dict) else RecurrentRolloutBuffer
    ...
    def collect_rollouts(
                ...
                if (
                    ...
                    with th.no_grad():
                        ...
                        terminal_value = self.policy.predict_values(
                            terminal_obs, terminal_lstm_state, episode_starts)[0]
        ...
        with th.no_grad():
            ...
            values = self.policy.predict_values(obs_as_tensor(
                new_obs, self.device), lstm_states.vf, episode_starts)
